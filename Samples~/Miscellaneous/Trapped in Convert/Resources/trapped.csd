<CsoundSynthesizer>
<CsOptions>
-odac -dm0 -+rtmidi=null -+msg_color=0 --sample-accurate
</CsOptions>
<CsInstruments>
;============================================================================;
;============================================================================;
...
;a0      oscil 5000, 440, 1
       ...
       chnset a1 + a3 + a5, SchanL
       chnset a7 + a9 + a11, SchanR
...
SchanR = p12
       ...
       chnset (a1 * .8) + a2, SchanL
       chnset (a1 * .6) + (a2 * .7), SchanR
garvb  =      garvb + (a2 * p10)
       endin
;============================================================================;
;==================================== GREEN =================================;
...
SchanL = p13
SchanR = p14
       chnset amix * kpan, SchanL
       chnset amix * (1 - kpan), SchanR
